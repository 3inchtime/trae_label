...
from .routers import tools, timestamp, json_tools, md5_tools, number_chinese, rsa_tools, timer, weight_convert, time_difference, temperature_convert
...
app.include_router(temperature_convert.router, prefix="/api/tools")

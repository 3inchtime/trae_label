  ...
  <div class="number-to-english">
    ...
    <div v-if="result" class="card">
      ...
      <div class="result-item main-result">
        <span class="result-label">英文大写</span>
        <span class="english-text">{{ result.english }}</span>
        <button @click="copyToClipboard(result.english)" class="copy-btn" title="复制">
    ...
    <div class="card">
      ...
      <div class="example-buttons">
        ...
        <button @click="setExample(9876543.21)" class="btn-secondary">9876543.21</button>
    ...
    <div class="card">
      ...
      <ul class="rules-list">
        ...
        <li>使用标准英文金额格式</li>
        <li>支持负数转换</li>
        <li>单位包括：Dollar, Cent, Thousand, Million, Billion, Trillion</li>
      </ul>
    </div>
...
<script setup>
import { ref } from 'vue'
import { convertNumberToEnglish } from '../api'
...
const convertNumber = async () => {
  ...
  try {
    const response = await convertNumberToEnglish({
